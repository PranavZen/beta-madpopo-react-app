...
import DsPolicyList from "../Components/DsPolicy/DsPolicyList";

function DsAcceptablePolicy() {
  return (
        ...
        <div className="container">
          <div className="gb_top_para">
            <div className="gb_pageTitle">
              <h1>Dedicated Server Acceptable use Policy</h1>
            </div>
          </div>
        </div>
      </div>
...
export default DsAcceptablePolicy;
