...
// var show_price_1 = "";
// var show_price_2 = "";
// if (products.woocomeData[0]["name"] == "POPO L") {
//   show_price = products.woocomeData[0]["priceThreeYearlyInINR"];
// } else if (products.woocomeData[1]["name"] == "POPO XL") {
//   show_price_1 = products.woocomeData[1]["priceThreeYearlyInINR"];
// } else if (products.woocomeData[2]["name"] == "POPO XXL") {
//   show_price_2 = products.woocomeData[2]["priceThreeYearlyInINR"];
// }
...
export default PriceCardBoxWoo;
