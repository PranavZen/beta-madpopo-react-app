      ...
      >
        <div className="d-flex mb-lg-7 plan-header">
          ...
          <div className="game-title">
            <h3 className="mb-6">
              <a href={props.cardAnchorLink}>{props.busEmailTitle}</a>
            </h3>
            <p className="fromText propsText">{props.busEmailSubTitle}</p>
        ...
        <ul className="ddos-first-features">
          <li>
            ...
            <span className="capAmt">{props.busEmailWebSpace} vCPU Cores</span>
          </li>
          <li>
            <span className="capTitle">Memory</span>
            <span className="capAmt">{props.busEmailCapacity} GB RAM</span>
          </li>
          <li>
            <span className="capTitle">Storage</span>
            <span className="capAmt">
              {props.busEmailCapacity2} NVMe or {props.busEmailCapacity3} SSD
            </span>
          </li>
        </ul>
