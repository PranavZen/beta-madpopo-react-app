      ...
      >
        <div className="d-flex mb-lg-7 plan-header">
          <div className="game-logo">
            <img src={props.resellerHostImg} alt={props.resellerHostAltName} />
          </div>
          <div className="game-title">
            <h3 className="mb-6">
              <a href={props.cardAnchorLink}>{props.resellerHostTitle}</a>
            </h3>
            <p className="fromText propsText">{props.resellerHostSubTitle}</p>
        ...
        <ul className="ddos-first-features">
          <li>
            ...
            <span className="capAmt">{props.resellerHostWebSpace} vCPU Cores</span>
          </li>
          <li>
            <span className="capTitle">Memory</span>
            <span className="capAmt">{props.resellerHostCapacity} GB RAM</span>
          </li>
          <li>
            <span className="capTitle">Storage</span>
            <span className="capAmt">
              {props.resellerHostCapacity2} NVMe or {props.resellerHostCapacity3} SSD
            </span>
          </li>
        </ul>
