...
import DDSData3 from "../Tabs/TabContentBox/HostingPlanData/DDSData3";
function DDSCard3(props) {
  //  console.log(props);
  var defaultPrice4 = DDSData3[props.id - 1].priceThreeYearlyInINR;
  ...
  if (selectedCountry == "$") {
    ...
    show_price = DDSData3[props.id - 1][show_currency];
  ...
  const handleFrequencyChange = (e) => {
    ...
    show_price_1 = DDSData3[props.id - 1][show_currency];
