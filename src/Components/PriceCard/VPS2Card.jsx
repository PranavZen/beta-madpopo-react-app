...
import virtualData from "../Tabs/TabContentBox/HostingPlanData/VPS2Data";
...
var bydefaultCurrency = "₹";
 ...
 if (selectedCountry == "$") {
   ...
   show_price = virtualData[props.id -1][show_currency];
...
//  console.log(show_price);
 ...
 const handleFrequencyChange = (e) => {
   ...
   show_price_1 = virtualData[props.id - 1][show_currency];
