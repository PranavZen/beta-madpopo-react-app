        ...
        <div className="row justify-content-start">
          <div className="col-md-8 col-lg-6 col-xl-8">
            <div className="hero-content dark-mode-texts mb-15 mb-lg-10 text-center text-md-left">
              <h4 className="text-uppercase mb-3 smalText">with madpopo</h4>
              ...
              <h1 className="position-relative mb-5 typedText">
                <span
                  id="typed"
                  ref={el}
                  className="typed strike-bottom green d-inline-block"
                >
                  and
                </span>
              ...
              <p className="mb-0 mb-10 typedSmallText">
                Book your domain now or connect our experts migrate your website
                for free
              </p>
            </div>
          </div>
          <div className="col-md-4 col-lg-6 col-xl-4">
            <div className="pcImageWrap">
              <div className="position-relative">
                ...
                //       <span className="small_circletext">.com</span>
                //     </div>
                //   </div>
                //   <div className="icon-block">
                //     <div className="small_cir">
                //       <span className="small_circletext">.net</span>
                //     </div>
                //   </div>
                //   <div className="icon-block">
                //     <div className="small_cir">
                //       <span className="small_circletext">.xyz</span>
                //     </div>
                //   </div>
                //   <div className="icon-block">
                //     <div className="small_cir">
                //       <span className="small_circletext">.shop</span>
                //     </div>
                //   </div>
                //   <div className="icon-block">
                //     <div className="small_cir">
                //       <span className="small_circletext">.me</span>
                //     </div>
                //   </div>
                //   <div className="icon-block">
                //     <div className="small_cir">
                //       <span className="small_circletext">.org</span>
                //     </div>
                //   </div>
                // </div>
              }
