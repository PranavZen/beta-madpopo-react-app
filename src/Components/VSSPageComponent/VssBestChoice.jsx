          ...
          <div className="col-md-5">
            <div className="wp_choice_leftBox">
              <div className="wp_choice_ContentBox">
                ...
                <p>
                With virtual server hosting, you pay only for the resources you need, making it a cost-effective solution for
              ...
              <div className="wp_choice_ContentBox">
                <h2>Root Access</h2>
                <p>
                With full root access, you can customize your server's settings and configurations to meet your specific
                needs.    
                </p>
              </div>
            </div>
