...
import PleskVdsData from "../Tabs/TabContentBox/HostingPlanData/PleskVdsData";
function PleskVDSPricingCardBox(props) {
// console.log(WindowsHostingDatas);
var defaultPrice2 =  PleskVdsData[props.id - 1].priceThreeYearlyInINR;
...
var bydefaultCurrency = "₹";
  ...
  if (selectedCountry == "$") {
    ...
    show_price = PleskVdsData[props.id -1][show_currency];
  ...
  const handleFrequencyChange = (e) => {
    ...
    show_price_1 = PleskVdsData[props.id - 1][show_currency];
      ...
      <div className="ddos-attack-package not-feaures-package shadow-2 priceCardDdos">
        <div className="toggleWrap d-flex">
          <h2 className="priceCardTitle mb-2">
            <Link to={props.winHostAnchor}>{props.winHostTitle}</Link>
          </h2>
        </div>
        ...
        <div className="selectDaysWrap pleskVdsDrop">
          <form>
            ...
            >
              ...
              <option value="priceYearlyIn">1 Month</option>
            </select>
          </form>
        </div>
...
export default PleskVDSPricingCardBox;
